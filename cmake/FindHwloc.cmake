...
#
# You may declare HWLOC_ROOT environment variable to tell where your hwloc
# library is installed.
#
# Once done this will define::
#
# Hwloc_FOUND            - True if hwloc was found Hwloc_INCLUDE_DIRS     -
# include directories for hwloc Hwloc_LIBRARIES        - link against these
# libraries to use hwloc Hwloc_VERSION          - version Hwloc_CFLAGS - include
# directories as compiler flags Hwloc_LDLFAGS          - link paths and libs as
# compiler flags
#
...
if(WIN32 AND NOT MINGW)
  find_path(
    Hwloc_INCLUDE_DIR
    NAMES hwloc.h
    PATHS ENV "PROGRAMFILES(X86)" ENV HWLOC_ROOT
  ...
  if(NOT _LINK_SUCCESS)
    if(CMAKE_SIZEOF_VOID_P EQUAL 8)
      ...
      message(
        STATUS
          "You are building 32bit code. If you like to build x64 use e.g. -G 'Visual Studio 12 Win64' generator."
      )
    endif()
  ...
  if(HWLOC_ROOT)
    set(ENV{PKG_CONFIG_PATH}
        "${HWLOC_ROOT}/lib/pkgconfig:$ENV{PKG_CONFIG_PATH}")
  else()
  ...
  if(Hwloc_FOUND)
    ...
    set(Hwloc_VERSION
        "${Hwloc_VERSION}"
        CACHE STRING "version of Hwloc as a list")
    list(GET Hwloc_VERSION_PARSED 0 Hwloc_VERSION_MAJOR)
    set(Hwloc_VERSION_MAJOR
        "${Hwloc_VERSION_MAJOR}"
        CACHE STRING "Major version of Hwloc")
    list(GET Hwloc_VERSION_PARSED 1 Hwloc_VERSION_MINOR)
    set(Hwloc_VERSION_MINOR
        "${Hwloc_VERSION_MINOR}"
        CACHE STRING "Minor version of Hwloc")
